...
function getLoc(loc) {
    ...
    fetch(geoFetch)
        ...
        .then(geoData => {
            ...
            .then(weaData => {
                d = Math.round(weaData["main"].temp) + "\u2103\t" + weaData["weather"][0].description;
                document.getElementById("basicWeather").innerText = d;
                document.getElementById("descIco").src = `https://openweathermap.org/img/wn/${weaData["weather"][0].icon}@2x.png`
